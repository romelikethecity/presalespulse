...
# Playwright-based OG image generator for PreSales Pulse.
...
def og_filename_from_path(rel_path):
    ...
    Examples:
        ...
        tools/consensus-review/index.html -> tools-consensus-review.png
        glossary/proof-of-concept/index.html -> glossary-proof-of-concept.png
    """
...
def generate_og_images(pages_data, output_dir, templates_dir, skip=False):
    ...
    with sync_playwright() as p:
        ...
        for i, page_info in enumerate(pages_data):
            ...
            title = html_module.escape(page_info.get("title", "PreSales Pulse"))
...
if __name__ == "__main__":
    ...
    test_pages = [
        {
            "rel_path": "index.html",
            "title": "PreSales Pulse",
            "subtitle": "Career intelligence for solutions engineers",
            "template": "og-default",
            "og_filename": "index.png",
        },
        {
            "rel_path": "salary/senior/index.html",
            "title": "Senior Solutions Engineer Salary",
            "subtitle": "$140K-$200K",
            "template": "og-salary",
            "og_filename": "salary-senior.png",
        },
        {
            "rel_path": "tools/consensus-review/index.html",
            "title": "Consensus Review 2026",
            "subtitle": "Interactive Demo Automation",
            "template": "og-tool",
            "og_filename": "tools-consensus-review.png",
            "category": "TOOL REVIEW",
        },
        {
            "rel_path": "glossary/proof-of-concept/index.html",
            "title": "What is a Proof of Concept?",
            "subtitle": "Clear definition with real examples for Solutions Engineers",
            "template": "og-glossary",
            "og_filename": "glossary-proof-of-concept.png",
        },
        {
            "rel_path": "insights/se-job-market/index.html",
            "title": "Solutions Engineer Job Market Analysis",
            "subtitle": "Weekly job market data and hiring trends",
            "template": "og-article",
            "og_filename": "insights-se-job-market.png",
        },
    ]
